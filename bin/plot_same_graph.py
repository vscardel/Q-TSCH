...
def main(options):
    ...
    subfolder = "simData/ComparisonResults100"

    for key in options.kpis:
        # load data
        file_path_msf = "simData/MSF100/exec_numMotes_100.dat.kpi"
        file_path_qlearning = 'simData/Q-Learning100/exec_numMotes_100.dat.kpi'
