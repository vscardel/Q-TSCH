...
def main(options):
    ...
    subfolder = "simData/ComparisonResults50"

    for key in options.kpis:
        # load data
        file_path_msf = "simData/MSF50/exec_numMotes_50.dat.kpi"
        file_path_qlearning = 'simData/Q-learning50/exec_numMotes_50.dat.kpi'
